from scripts.ctp_colors import *
from scripts.default_colors import *

color_dic = {'lavender':'', 'mauve':'-t -purple', 'pink':'-t -pink', 'red':'-t -red', 'peach':'-t -orange', 'yellow':'-t -yellow', 'green':'-t -green', 'teal':'-t -teal'}
